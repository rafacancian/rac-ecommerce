package com.ecommerce.kafka.consumer.fraud;
...
public class ConsumerFraudDetector {
    ...
    public static void execute() {
        ...
        kafkaConsumer.subscribe(Collections.singletonList("ECOMMERCE_FRAUD_DETECTOR"));

        Thread thread = new Thread(() -> {
            System.out.println("Thread of ConsumerFraudDetector");
            while (true) {
    ...
    private static Properties getProperties() {
        ...
        properties.setProperty(ConsumerConfig.GROUP_ID_CONFIG, ConsumerFraudDetector.class.getSimpleName());
        return properties;
    }
}
